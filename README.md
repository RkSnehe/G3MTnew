...
This project simulates one module of the new GRAPES-3 Muon Telescope (G3MT).

# changes 
//1 
The new G3MT has a reduced absorber thickness. We have reduced from 2m thickness to 1m.
